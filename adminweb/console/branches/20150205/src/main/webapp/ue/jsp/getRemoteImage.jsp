...
<%@ page language="java" pageEncoding="utf-8"%>
    ...
    <%
    	...
    	for(int i=0;i<arr.length;i++){
			...
			File f = new File(str);
			String savePath = Resources.getString( "filePath" );
    		//格式验证
			...
			String filedir = Resources.getString( "filePath" )+path;
			
			String httpurl =  Resources.getString( "fileUrl" )+path;
    		...
    		File savetoFile = new File(filedir +"/"+ saveName);
    		outSrc[i]=httpurl + saveName;
    		try {
