...
(function () {
     ...
     */
    var URL = window.UEDITOR_HOME_URL || "/ue/";
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,imagePath: myImagePath                 //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        ...
        ,scrawlPath:myImagePath                          //图片修正地址，同imagePath

        //附件上传配置区
        ,fileUrl:URL+"jsp/fileUp.jsp"               //附件上传提交地址
        ,filePath:myImagePath                   //附件修正地址，同imagePath
        //,fileFieldName:"upfile"                    //附件提交的表单名，若此处修改，需要在后台对应文件修改对应参数

        //远程抓取配置区
        //,catchRemoteImageEnable:true               //是否开启远程图片抓取,默认开启
        ,catcherUrl:URL +"jsp/getRemoteImage.jsp"   //处理远程图片抓取的地址
        ,catcherPath:myImagePath               //图片修正地址，同imagePath
        ...
        , toolbars:[
            ['fullscreen', 'source', '|', 'undo', 'redo', '|',
                ...
                'insertimage', 'emotion', 'music',  'insertframe', 'pagebreak', 'template', 'background', '|',
