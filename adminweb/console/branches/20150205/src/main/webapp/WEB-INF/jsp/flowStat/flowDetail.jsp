...
<body>
	<form action="/flowStatManage/updateFlowStat" style="padding:0 10px 0 10px; margin-top:0px" method="post" id="updateFlowStatForm">
		<div>
			<label style="font-size: 16px;font-weight: bold;">流量统计详情:</label>
		...
		<div class="b-con a-form">
			<div align="center">
				...
				<div class="input-prepend">
					...
					<input type="text" autocomplete="off" value="${flow.date }" class="inptime span2" style="width:70px" id="date" name="date">
                </div>
				</label>
				<label class="pr15">域名：
				...
				<label class="pr15">uv：
					...
					<input type="hidden" id="dataType" name="dataType" value="${flow.dataType }"/>
				</label>
			</div>
			<span style="width:100px;padding-right:16px;padding-left:16px;vertical-align:top"></span>
			<div align="center">
				<label class="pr15">
					<input id="updateFlow" type="button" value="保存" class="btn btn-info"/>
				</label>
			</div>
		</div>
		</div>
