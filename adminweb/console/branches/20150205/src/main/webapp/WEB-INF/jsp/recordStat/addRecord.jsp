...
<body>
	<form action="/recordStatManage/addRecordStat" style="padding:0 10px 0 10px; margin-top:0px" method="post" id="addRecordStatForm">
		<div>
			<label style="font-size: 16px;font-weight: bold;">收录统计添加:</label>
			<!-- 
		...
		<div class="b-con a-form">
			<div align="center">
				...
				<label class="pr15" style="width: 200px">搜索引擎：
	          			<select id="queryEngine" name="queryEngine">
							<option value="baidu" <c:if test="${record.indexNumber == 'baidu' }">selected</c:if>>百度</option>
						</select>
	          	</label>
			</div>
			...
			<div align="center">
				<label class="pr15">
					<input id="subRecord" type="button" value="保存" class="btn btn-info"/>
				</label>
			</div>
		</div>
		</div>
