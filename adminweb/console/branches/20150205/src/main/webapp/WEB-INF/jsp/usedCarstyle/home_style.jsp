...
<body>
<form action="/used/toListFstyle" method="post" style="padding:0 10px 0 10px;margin-top:0px; " >
	<div id="tabs" class="tabs">  
		<ul>
			<li class="tabs_active"><a href="/used/toListFstyle">二手车车款列表</a></li>
			<li  style="background:url(/images/ui-bg_glass_75_e6e6e6_1x400.png) #e6e6e6 repeat-x 50% 50%" ><a href="/used/toAdd?modelstr=style">添加二手车车款</a></li>
		</ul>
   </div>
   <table>
		<tr class="lh28">
		...
		<table class="table_style table table-bordered" >
			<thead>
				<tr class="attr">
					...
					<th style="white-space:nowrap;">车型</th>
					<th style="white-space:nowrap;">关联新车车款</th>
			...
			<c:if test="${list != null }">
				<c:forEach items="${list }" var="obj">
					<tr>
						...
						<td>
							<a href="/used/toUpdate?modelstr=style&id=${obj.id }">修改</a>
							<a  id="delete" onclick="deletec(${obj.id },'style')" >删除</a>
						</td>																																																												</td>
					</tr>
				</c:forEach>
			</c:if>
