...
<body>
	<div id="tabs" class="tabs">  
					<ul>
						<li class="tabs_active"><a href="/sites/carstyle/carStyleHomeAll">全部车款列表</a></li>
...
<form action="/sites/carstyle/styleEdit" method="post" style="padding:0 10px 0 10px; margin-top:0px" id="addForm">
<input type="hidden" name="myppid" value="${myppid }">
<input type="hidden" name="id" value="${sdomain.id }">
<input type="hidden" name="brandName" value="${brandName }">
<input type="hidden" name="cLppid" value="${cLppid }">
<input type="hidden" name="cName" value="${cName }">
<input type="hidden" name="statusid" value="${statusid}">
<input type="hidden" name="ppid" value="${myppid }">
	<div class="borderDiv">
	...
	<div class="borderDiv">
		...
		<td class="ti">品牌名称:</td>
					<td>
					<select disabled="disabled" style="width: 280px;" onchange="getStylemy(this.options[this.options.selectedIndex].value)" id="brandName">
		...
		<tr>
		<tr>
		 	<td style="vertical-align:top" >所属车系：</td>
                <td>
                <select  disabled="disabled"  id="ppid" style="width: 280px;">
            	...
            	<td style="vertical-align:top" >品牌标识:</td>
                  <td>
                	<select sta="p" staName="品牌标识" name="publicMark" style="width: 280px;" >
                		<option <c:if test="${sdomain.publicMark==null }">selected="selected"</c:if> value="">请选择</option>
                		<option <c:if test="${sdomain.publicMark==0 }">selected="selected"</c:if> value="0">全部</option>
                		<option <c:if test="${sdomain.publicMark==1 }">selected="selected"</c:if> value="1">新车</option>
                		<option <c:if test="${sdomain.publicMark==2 }">selected="selected"</c:if> value="2">二手车</option>
                	</select><span class="font" style="color: red">*</span>
                </td>
            </tr>
            <tr>
            	<td style="vertical-align:top">车款名称：</td>
                <td><input maxlength="50" type="text"  id="name" name="style" value="${sdomain.style }" style="width: 280px;height: 25px" onchange="verificationmy()"/>
            ...
            <tr>
                ...
                <td>
                <input type="text" name="factoryPrice" maxlength="50" id="factoryPrice" value="${sdomain.factoryPrice }" style="width: 280px;height: 25px" onkeyup="this.value=this.value.replace(/[^\d.]/g,'')"><span style="color:red;">* (请输入数字示例：xx.00)</span>
                </td>
            </tr>
              ...
              <%-- <tr>
                ...
                <td>
                <input type="text" name="marketPrice" id="marketPrice" value="${sdomain.marketPrice }" maxlength="50" style="width: 280px;height: 25px"><span style="color:red;">* (请控制50字以内)</span>
                </td>
            </tr> --%>
             <%-- <tr>
 			...
 			<select name="bos" id="bos" style="width: 280px;">
            	 	<option value="">请选择</option>
            	 <option value="2"  <c:if test="${sdomain.bos<=2 }">selected="selected"</c:if>>小型车</option>
            	 <option value="4"  <c:if test="${sdomain.bos>2&&sdomain.bos<=4 }">selected="selected"</c:if>>中型车</option>
            	 <option value="9" <c:if test="${sdomain.bos>42&&sdomain.bos<=9 }">selected="selected"</c:if>>大型车</option>
            	 </select> <span style="color:red;">*</span>
            	 </td>
            </tr> --%>
               <tr>
            	<td style="vertical-align:top">排量:</td>
            	 <td><input type="text" name="level" id="level" value="${sdomain.level }" style="width: 280px;height: 25px" maxlength="50"><span style="color:red;">* (请控制50字以内)</span></td>
            </tr>
               <tr>
            	<td style="vertical-align:top">变速箱:</td>
            	 <td><input type="text" name="speedBox" id="speedBox" value="${sdomain.speedBox }" style="width: 280px;height: 25px" maxlength="50"><span style="color:red;">* (请控制50字以内)</span></td>
            </tr>
            
               <tr>
            	<td style="vertical-align:top">车身颜色:</td>
            	 <td><input type="text" name="colors" id="colors" value="${sdomain.colors }" style="width: 280px;height: 25px" maxlength="200"><span style="color:red;">(请控制200字以内)</span></td>
            </tr>
             <tr>
            	<td style="vertical-align:top">详细:</td>
                <td>
              <textarea maxlength="200" rows="3" cols="60" name="texts" >${sdomain.texts }</textarea><span style="color:red;">(请控制200字以内)</span>
                </td>
            </tr>
            <tr><td>
