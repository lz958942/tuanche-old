...
<table border="0" cellpadding="2" cellspacing="2" align="center" width="100%">
	...
	<div id="query">
		...
		<input type="button" <c:if test="${empty deduplication }">value="重复检查" </c:if>
		<c:if test="${not empty deduplication }">disabled="disabled" value="检查中，请稍后···"</c:if> onclick="window.location.href='/questionAnswer/deduplication'">
		<input type="button" value="查询（仅重复）" onclick="javascript:toDeduplication()">
	</div>
