...
<div class="tc_container_3">
	<div class="tc_header_main clearfix">
    	<div class="tc_logo_wrap">
        	<#if !yh_weight?exists><h1></#if><a href="http://${oldHost}/" class="tc_logo" title="团车网">团车网</a><#if !yh_weight?exists></h1></#if>
            <span>买车！就上团车网</span>
        </div>
        <div class="tc_search_wrap tc_search_middle">
        	<div class="tc_search">
            	...
            	<form action="http://bj.${oldHost}/tuan/search/" method="post">
            	...
            	<dl class="clearfix">
                    ...
                    <#if hotSearch?exists>
		            	<#list hotSearch as search>
		            		<dd><a href="http://${city.py}.${oldHost}/c${search.id?c}/tuan/" target="_blank">${search.name}</a></dd>
		            	</#list>
            		</#if>
                </dl>
            </div>
...
<div class="tc_container_1 tc_nav tc_nav_bb">
	<div class="tc_container_3">
    	<dl class="clearfix">
            <dd><a href="http://${city.py}.${oldHost}/" target="_blank">首页</a></dd>
            ...
            <dd class="sub_nav">
             ...
             <#if have_zixun?exists>
             	<dd <#if isZixun?exists>class="cur"</#if>><a  href="http://${city.py}.${oldHost}/zx/" title="团购资讯" target="_blank">团购资讯</a></dd>
            </#if>
        </dl>
    </div>
</div>