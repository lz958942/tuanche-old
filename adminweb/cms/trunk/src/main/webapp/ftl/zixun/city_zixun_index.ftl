...
<link rel="canonical" href="http://${city.py}.${oldHost}/zx/"/> 
            ...
            <#if city_zixun_2_right?exists>
	            	...
	            	<#if city_zixun_2_right.adLink?exists>
	 				<a target="_blank" href="${city_zixun_2_right.adLink}">
			 			...
			 			<img id="adClick_city_zixun_2_right" alt="${city_zixun_2_right.adTitle}" src="${city_zixun_2_right.picName}" width="221px" height="200px" />
			   		 <#if city_zixun_2_right.adLink?exists>
		 			</a>
		 			</#if>
		 		</div>
...
<script>
  ...
  ga('create', 'UA-50202854-1', '${oldHost}');
  ga('send', 'pageview');
...
<script type="text/javascript">
$(function(){
	$("#adClick_city_zixun_2_right").live("click",function(){
		 var d = new Date();
		 if(d.getMonth()==2 && d.getDate()<24){
		 	$.get("http://click.gridsumdissector.com/track.ashx?gsadid=gad_143_KG70ZGCV&u=http%3a%2f%2f3%e6%9c%8812%e6%97%a5%e4%b9%8b%e5%89%8d");
		 }
	});
});
</script>
