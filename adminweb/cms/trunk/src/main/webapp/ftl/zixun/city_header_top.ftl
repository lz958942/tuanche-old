...
<div class="tc_header">
	<div class="tc_container_2 clearfix">
        <div class="fl city_wrap clearfix">
            <div class="current_city cur_city fl"><a href="http://${city.py}.${oldHost}/" data-cur="${city.id}">${city.dname}</a></div>
                        ...
                        <ul>
                           <#if changeCity?exists>
		                           ...
		                           <li>
		                                ...
		                                <div class="s_ul">
		                                	<#list citys as city>
		                                    		<a title="${city.name}汽车团购" <#if city.openStatus == 3>class="ready"</#if>  href="http://${city.py!""}.${oldHost}/" target="_blank">   ${city.name}</a>
		                                    </#list>
		                                </div>
                ...
                <div class="tc_focus_wrap tc_focusyiyi_wrap">
                    <div class="tc_focus_con">
                        ...
                        <div class="clearfix tc_focusyiyi_wrap-img">
                            <a href="http://${oldHost}/zx-wh/xw/558046.html" target="_blank"><img src="${staticFile}/public/images/yiyi.png"/></a>
                        </div>
                    </div>
                </div>
            </div> 
