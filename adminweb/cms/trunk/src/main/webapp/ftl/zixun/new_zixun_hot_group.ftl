			...
			<#if hot_groupbuy?exists && hotGroupBuy?exists>
				<#list hotGroupBuy as carStyle>
					<#if carStyle_index lt 8 && carStyle?exists>
						<li class="fl">
							<div class="hotpic">
								<a pl="pg=zixuIndex&pl=hotche" href="${carStyle.buyUrl}" target="_blank" pl="pg=zixunIndex&amp;pl=bottom">
									<img alt="${carStyle.title}" title="${carStyle.title}" src="${carStyle.spic}"></a>
							</div>
							<div class="hottit">
								<a pl="pg=zixuIndex&pl=hotche" href="${carStyle.buyUrl}" target="_blank" title="${carStyle.title}" pl="pg=zixunIndex&amp;pl=bottom">${carStyle.title}</a>
								-
								<a pl="pg=zixuIndex&pl=hotche" href="${carStyle.buyUrl}" target="_blank" rel="nofollow" pl="pg=zixunIndex&amp;pl=bottom">${carStyle.dateStr}</a>
							</div>
