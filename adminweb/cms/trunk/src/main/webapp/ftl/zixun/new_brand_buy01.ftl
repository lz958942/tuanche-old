			...
			<#list contentList as content>
                <li>
                    ...
                    <div class="hotCarList-img">
                      <a pl="pg=cityIndex&pl=hot" pl="pg=cityIndex&pl=hot" target="_blank" href="${content.buyUrl!''}"><img src="${staticFile}/public/images/blank.gif" alt="" width="300" height="200" data-url="${content.spic!''}" class="scrollLoading" /></a>
                    </div>
                    <div class="hotCarList-info"> 
                       <p><a pl="pg=cityIndex&pl=hot" pl="pg=cityIndex&pl=hot" target="_blank" href="${content.buyUrl!''}"> ${content.allTitle}</a></p>
                ...
                <div class="clearfix title-index title-index1">
                    ...
                    <div class="fr title-index-link">
                    	<#list 1..5 as num>
			        		...
			        		<#if plate!="">
			        			 <a pl="pg=cityIndex&pl=hot" href="javascript:void(0);"  <#if num == 1>class="cur"</#if>>${plate.title}</a>  
			        		</#if>
			        	</#list>
                    </div>
                </div>
