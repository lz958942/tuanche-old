package com.tuanche.cms.common.page.plugin;
...
import com.tuanche.cms.common.util.ReflectHelper;
	...
	public Object intercept(Invocation ivk) throws Throwable {
		if (ivk.getTarget() instanceof RoutingStatementHandler) {
			...
			if (mappedStatement.getId().matches(".*" + pageSqlId)) { // 拦截需要分页的SQL
				...
				countSql = "select count(0)  from (" + sql + " ) t_count "; // 记录统计
				countSql =  cs; // 记录统计
					
				System.out.println(upperCaseSql+"9999");
