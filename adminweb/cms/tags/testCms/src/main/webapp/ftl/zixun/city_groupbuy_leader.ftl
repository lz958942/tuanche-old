		                    	...
		                    	<#list userbrands as brand>
		                    		<#if brand_index <4 >
			                    		<#if brand_index != 0>
			                    		  ...
			                    		  <a pl="pg=cityIndex&pl=leader&empNo=${user.empNo}" target="_blank" href="http://${city.py}.tuanche.com/b${brand.id}/tuan/"><img src="${staticFile}/public/images/blank.gif" alt="" width="27" height="27" data-url="${brand.logo}" class="scrollLoading" /></a>
		                    		</#if>
		                    	</#list>
		                    </div>
		                </li>
