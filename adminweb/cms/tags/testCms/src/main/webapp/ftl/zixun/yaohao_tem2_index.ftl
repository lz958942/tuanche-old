...
<link rel="canonical" href="http://${city.py}.tuanche.com/yh/"/> 
</head>
...
<#include  "yaohao_content5.ftl"/>
    ...
    <div class="tc_container_1">
    	<div class="tc_container_1">
        	<div class="big_title border_b_b">
            	<div class="title_text title_c border_b_c"><span class="sepa_l">车牌申请</span>及竞拍</div>
            </div>
        </div>
        <div class="tc_container_1 clearfix">
        	<!--办理登记摇号条件-->
	    	<@havaNumber plate = car_num_apply_tem1_yh!"" contentList=car_num_apply_tem1_yh_contentList![] flay=1></@havaNumber>
	    	<!--企业申请-->
	        <@havaNumber plate = car_num_apply_tem2_yh!"" contentList=car_num_apply_tem2_yh_contentList![] flay=1></@havaNumber>
	        <!--车牌竞价指引-->
	    	<@havaNumber plate = car_num_apply_tem3_yh!"" contentList=car_num_apply_tem3_yh_contentList![] flay=1></@havaNumber>
	    	<!--更新车辆-->
	        <@havaNumber plate = car_num_apply_tem4_yh!"" contentList=car_num_apply_tem4_yh_contentList![] flay=1></@havaNumber>
        </div>
    </div>
...
<div class="yh_result_layer" id="yh_result_layer">
	<div class="close_wrap"><a href="javascript:;">×</a></div>
    ...
    <div class="result_con_btn_wrap">
    	<a href="http://${city.py}.tuanche.com/tuan/" class="result_con_btn" id="result_con_btn"></a>
    </div>
</div>
